...
int main() {
    ...
    while (true) {
        ...
        switch (a) {
            case 1:
                object.simple_calculator();
                object.choise_simple_calculator();
                break;
            case 2:
                object.trigonometric_calculator();
                object.choise_trigonometric_calculator();
                break;
            case 3:
                object.equations();
                object.choise_equations();
                break;
            case 4:
                object.complex_Number();
                object.choise_complex_number();
                break;
            case 5:
                object.logical_operator();
                object.choise_logical_operator();
                break;
            case 6:
